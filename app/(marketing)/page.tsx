...
const testimonials = [
  {
    quote:
      'ClientFlow replaced 4 different tools I was using. Everything I need to run my freelance business is now in one place.',
    name: 'Sarah Chen',
    role: 'UX Designer',
    avatar: 'SC',
  },
  {
    quote:
      'The Kanban board alone saved me hours every week. I can finally see exactly where every task stands across all my projects.',
    name: 'Marcus Rivera',
    role: 'Web Developer',
    avatar: 'MR',
  },
  {
    quote:
      'My clients are impressed when I send them project updates pulled straight from ClientFlow. It makes me look so much more professional.',
    name: 'Priya Patel',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-indigo-50/50 to-white">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
            ClientFlow gives you everything you need to manage clients, projects, and tasks — in one clean dashboard.
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/signup"
              className="w-full sm:w-auto bg-indigo-600 text-white px-8 py-4 rounded-xl font-semibold text-base hover:bg-indigo-700 transition-all hover:shadow-lg hover:shadow-indigo-200"
            >
              Start for free →
            </Link>
            ...
            <Link
              href="/login"
              className="w-full sm:w-auto border border-gray-200 text-gray-700 px-8 py-4 rounded-xl font-semibold text-base hover:bg-gray-50 transition-colors"
            >
                ...
                {['Dashboard', 'Clients', 'Projects', 'Tasks', 'Settings'].map((item, i) => (
                  <div
                    ...
                    className={`text-xs px-3 py-2 rounded-lg ${
                      i === 0 ? 'bg-indigo-600 text-white' : 'text-gray-400'
                    }`}
                  >
                    {item}
                  </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500 max-w-2xl mx-auto">
              One tool to replace your scattered spreadsheets, sticky notes, and email chains.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((f) => (
              <div
                key={f.title}
                className="group p-6 rounded-2xl border border-gray-100 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-50 transition-all"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            {pricing.map((plan) => (
              ...
              >
                <div className={`text-sm font-semibold mb-1 ${plan.highlight ? 'text-indigo-200' : 'text-gray-500'}`}>
                  {plan.name}
                </div>
                ...
                <div className={`text-sm mb-4 ${plan.highlight ? 'text-indigo-200' : 'text-gray-400'}`}>
                  {plan.period}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500">
              Join hundreds of freelancers who've simplified their business.
            </p>
          </div>
      ...
      <section className="py-24 px-6 bg-indigo-600">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          ...
          <Link
            href="/signup"
            className="inline-block bg-white text-indigo-600 px-10 py-4 rounded-xl font-bold text-base hover:bg-indigo-50 transition-colors"
          >
